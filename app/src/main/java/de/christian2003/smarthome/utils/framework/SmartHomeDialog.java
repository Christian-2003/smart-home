 ...
 */
public class SmartHomeDialog<V extends ViewModel> extends BottomSheetDialogFragment {
    ...
    public interface Callback extends Serializable {
         ...
         */
        void onCallback(SmartHomeDialog<? extends ViewModel> dialog, int resultCode);
     ...
     */
    public SmartHomeDialog(@Nullable Class<V> viewModelType, @LayoutRes int layoutRes) {
