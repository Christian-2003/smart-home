...
public class KeyStoreHelper {
    ...
    /**
     * Attribute stores the context from which to access the shared preferences.
     */
    @NonNull
    ...
    /**
     * Constructor instantiates a new key store helper.
     *
     * @param context   Context for the key store helper.
     */
    ...
    public void saveCertToInternalStorage(@NonNull Uri uri) throws Exception {
        ...
        try (InputStream is = context.getContentResolver().openInputStream(uri); OutputStream os = Files.newOutputStream(certFile.toPath())) {
            Log.d(TAG, "Uri=" + uri);
    ...
    public File getCertFile() {
        return new File(context.getFilesDir(), CERT_NAME);
    }
