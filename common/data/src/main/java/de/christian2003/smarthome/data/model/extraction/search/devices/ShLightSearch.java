...
public class ShLightSearch extends ShGenericDevice {
    /**
     ...
     */
    public ShLightSearch(@NonNull String name, @Nullable String specifier, @Nullable String imageUri, @Nullable String onButtonText, @Nullable String offButtonText, @Nullable String milliAmp) {
